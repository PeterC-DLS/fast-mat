...
Deno.test("Adds 1x1 (WASM F64)", () => {
  const resultWasm = addMatrixWasmF64({ shape: [1, 1], data: mat1AF64 }, {
    shape: [1, 1],
    data: mat1BF64,
  });
...
Deno.test("Adds 2x2 (WASM F64)", () => {
  const resultWasm = addMatrixWasmF64({ shape: [2, 2], data: mat2AF64 }, {
    shape: [2, 2],
    data: mat2BF64,
  });
...
Deno.test("Adds 16x16 (WASM F64)", () => {
  const resultWasm = addMatrixWasmF64({ shape: [16, 16], data: mat16AF64 }, {
    shape: [16, 16],
    data: mat16BF64,
  });
...
Deno.test("Adds 128x128 (WASM F64)", () => {
  const resultWasm = addMatrixWasmF64({ shape: [128, 128], data: mat128AF64 }, {
    shape: [128, 128],
    data: mat128BF64,
  });
...
Deno.test("Adds 1x1 (SIMD F64)", () => {
  const resultWasm = addMatrixWasmSimdF64({ shape: [1, 1], data: mat1AF64 }, {
    shape: [1, 1],
    data: mat1BF64,
  });
  assertEquals(resultWasm.data, mat1ResultF64);
...
Deno.test("Adds 2x2 (SIMD F64)", () => {
  const resultWasm = addMatrixWasmSimdF64({ shape: [2, 2], data: mat2AF64 }, {
    shape: [2, 2],
    data: mat2BF64,
  });
  assertEquals(resultWasm.data, mat2ResultF64);
...
Deno.test("Adds 16x16 (SIMD F64)", () => {
  const resultWasm = addMatrixWasmSimdF64(
    { shape: [16, 16], data: mat16AF64 },
    { shape: [16, 16], data: mat16BF64 },
  );
  assertEquals(resultWasm.data, mat16ResultF64);
});
...
Deno.test("Adds 64x64 (SIMD F64)", () => {
  const resultWasm = addMatrixWasmSimdF64(
    { shape: [64, 64], data: mat64AF64 },
    { shape: [64, 64], data: mat64BF64 },
  );
...
Deno.test("Adds 1x1 (SIMD F32)", () => {
  const resultWasm = addMatrixWasmSimdF32({ shape: [1, 1], data: mat1AF32 }, {
    shape: [1, 1],
    data: mat1BF32,
  });
...
Deno.test("Adds 2x2 (SIMD F32)", () => {
  const resultWasm = addMatrixWasmSimdF32({ shape: [2, 2], data: mat2AF32 }, {
    shape: [2, 2],
    data: mat2BF32,
  });
...
Deno.test("Adds 16x16 (SIMD F32)", () => {
  const resultWasm = addMatrixWasmSimdF32(
    { shape: [16, 16], data: mat16AF32 },
    { shape: [16, 16], data: mat16BF32 },
  );
...
Deno.test("Adds 64x64 (SIMD F32)", () => {
  const resultWasm = addMatrixWasmSimdF32(
    { shape: [64, 64], data: mat64AF32 },
    { shape: [64, 64], data: mat64BF32 },
  );
...
Deno.test("Adds 1x1 (SIMD I32)", () => {
  const resultWasm = addMatrixWasmSimdI32({ shape: [1, 1], data: mat1AI32 }, {
    shape: [1, 1],
    data: mat1BI32,
  });
...
Deno.test("Adds 2x2 (SIMD I32)", () => {
  const resultWasm = addMatrixWasmSimdI32({ shape: [2, 2], data: mat2AI32 }, {
    shape: [2, 2],
    data: mat2BI32,
  });
...
Deno.test("Adds 16x16 (SIMD I32)", () => {
  const resultWasm = addMatrixWasmSimdI32(
    { shape: [16, 16], data: mat16AI32 },
    { shape: [16, 16], data: mat16BI32 },
  );
...
Deno.test("Adds 64x64 (SIMD I32)", () => {
  const resultWasm = addMatrixWasmSimdI32(
    { shape: [64, 64], data: mat64AI32 },
    { shape: [64, 64], data: mat64BI32 },
  );
