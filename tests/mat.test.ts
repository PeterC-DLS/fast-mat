...
Deno.test("Adds 1x1", () => {
  ...
  const resultFlat = addMatrixFlat(
    nestedArrayToFlat(mat1ANum),
    nestedArrayToFlat(mat1BNum),
  );
  const resultFlatPresize = addMatrix1x1Flat(
    nestedArrayToFlat(mat1ANum),
    nestedArrayToFlat(mat1BNum),
  );
  const resultFlatDynamic = genMatAddFlatFunc(1, 1)(
    nestedArrayToFlat(mat1ANum),
    nestedArrayToFlat(mat1BNum),
  );
  const resultF64 = addMatrixFloat64({ shape: [1, 1], data: mat1AF64 }, {
    shape: [1, 1],
    data: mat1BF64,
  });
  const resultF32 = addMatrixFloat32({ shape: [1, 1], data: mat1AF32 }, {
    shape: [1, 1],
    data: mat1BF32,
  });
  const resultI32 = addMatrixInt32({ shape: [1, 1], data: mat1AI32 }, {
    shape: [1, 1],
    data: mat1BI32,
  });
...
Deno.test("Adds 2x2", () => {
  ...
  const resultFlat = addMatrixFlat(
    nestedArrayToFlat(mat2ANum),
    nestedArrayToFlat(mat2BNum),
  );
  const resultFlatPresize = addMatrix2x2Flat(
    nestedArrayToFlat(mat2ANum),
    nestedArrayToFlat(mat2BNum),
  );
  const resultFlatDynamic = genMatAddFlatFunc(2, 2)(
    nestedArrayToFlat(mat2ANum),
    nestedArrayToFlat(mat2BNum),
  );
  const resultFlatF64 = addMatrixFloat64({ shape: [2, 2], data: mat2AF64 }, {
    shape: [2, 2],
    data: mat2BF64,
  });
  const resultFlatF32 = addMatrixFloat32({ shape: [2, 2], data: mat2AF32 }, {
    shape: [2, 2],
    data: mat2BF32,
  });
  const resultFlatI32 = addMatrixInt32({ shape: [2, 2], data: mat2AI32 }, {
    shape: [2, 2],
    data: mat2BI32,
  });
...
Deno.test("Adds 4x4", () => {
  ...
  const resultF64 = addMatrixFloat64({ shape: [4, 4], data: mat4AF64 }, {
    shape: [4, 4],
    data: mat4BF64,
  });
  const resultFlatF32 = addMatrixFloat32({ shape: [4, 4], data: mat4AF32 }, {
    shape: [4, 4],
    data: mat4BF32,
  });
  const resultI32 = addMatrixInt32({ shape: [4, 4], data: mat4AI32 }, {
    shape: [4, 4],
    data: mat4BI32,
  });
...
Deno.test("Adds 100x100", () => {
  ...
  const resultFlat = addMatrixFlat(
    nestedArrayToFlat(mat128ANum),
    nestedArrayToFlat(mat128BNum),
  );
  const resultFlatPresize = addMatrix128x128Flat(
    nestedArrayToFlat(mat128ANum),
    nestedArrayToFlat(mat128BNum),
  );
  const resultFlatDynamic = genMatAddFlatFunc(128, 128)(
    nestedArrayToFlat(mat128ANum),
    nestedArrayToFlat(mat128BNum),
  );
  const resultF64 = addMatrixFloat64({ shape: [128, 128], data: mat128AF64 }, {
    shape: [128, 128],
    data: mat128BF64,
  });
  const resultF32 = addMatrixFloat32({ shape: [128, 128], data: mat128AF32 }, {
    shape: [128, 128],
    data: mat128BF32,
  });
  const resultI32 = addMatrixInt32({ shape: [128, 128], data: mat128AI32 }, {
    shape: [128, 128],
    data: mat128BI32,
  });
