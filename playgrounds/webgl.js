...
{
  const result = await addMatrixWebGl({ shape: [2, 2], data: mat2AF32 }, {
    shape: [2, 2],
    data: mat2BF32,
  });
...
{
  const result = await addMatrixWebGl({ shape: [4, 4], data: mat4AF32 }, {
    shape: [4, 4],
    data: mat4BF32,
  });
...
{
  const result = await addMatrixWebGl({ shape: [128, 128], data: mat128AF32 }, {
    shape: [128, 128],
    data: mat128BF32,
  });
