...
Deno.bench("Add 1x1 (F64)", { group: "1x1" }, () => {
  addMatrixFloat64({ shape: [1, 1], data: mat1AF64 }, {
    shape: [1, 1],
    data: mat1BF64,
  });
});
...
Deno.bench("Add 2x2 (F64)", { group: "2x2" }, () => {
  addMatrixFloat64({ shape: [2, 2], data: mat2AF64 }, {
    shape: [2, 2],
    data: mat2BF64,
  });
});
...
Deno.bench("Add 4x4 (F64)", { group: "4x4" }, () => {
  addMatrixFloat64({ shape: [4, 4], data: mat4AF64 }, {
    shape: [4, 4],
    data: mat4BF64,
  });
});
...
Deno.bench("Add 8x8 (F64)", { group: "8x8" }, () => {
  addMatrixFloat64({ shape: [8, 8], data: mat8AF64 }, {
    shape: [8, 8],
    data: mat8BF64,
  });
});
...
Deno.bench("Add 16x16 (F64)", { group: "16x16" }, () => {
  addMatrixFloat64({ shape: [16, 16], data: mat16AF64 }, {
    shape: [16, 16],
    data: mat16BF64,
  });
});
...
Deno.bench("Add 32x32 (F64)", { group: "32x32" }, () => {
  addMatrixFloat64({ shape: [32, 32], data: mat32AF64 }, {
    shape: [32, 32],
    data: mat32BF64,
  });
});
...
Deno.bench("Add 64x64 (F64)", { group: "64x64" }, () => {
  addMatrixFloat64({ shape: [64, 64], data: mat64AF64 }, {
    shape: [64, 64],
    data: mat64BF64,
  });
});
...
Deno.bench("Add 128x128 (F64)", { group: "128x128" }, () => {
  addMatrixFloat64({ shape: [128, 128], data: mat128AF64 }, {
    shape: [128, 128],
    data: mat128BF64,
  });
});
...
Deno.bench("Add 256x256 (F64)", { group: "256x256" }, () => {
  addMatrixFloat64({ shape: [256, 256], data: mat256AF64 }, {
    shape: [256, 256],
    data: mat256BF64,
  });
});
...
Deno.bench("Add 1x1 (F32)", { group: "1x1" }, () => {
  addMatrixFloat32({ shape: [1, 1], data: mat1AF32 }, {
    shape: [1, 1],
    data: mat1BF32,
  });
});
...
Deno.bench("Add 2x2 (F32)", { group: "2x2" }, () => {
  addMatrixFloat32({ shape: [2, 2], data: mat2AF32 }, {
    shape: [2, 2],
    data: mat2BF32,
  });
});
...
Deno.bench("Add 4x4 (F32)", { group: "4x4" }, () => {
  addMatrixFloat32({ shape: [4, 4], data: mat4AF32 }, {
    shape: [4, 4],
    data: mat4BF32,
  });
});
...
Deno.bench("Add 8x8 (F32)", { group: "8x8" }, () => {
  addMatrixFloat32({ shape: [8, 8], data: mat8AF32 }, {
    shape: [8, 8],
    data: mat8BF32,
  });
});
...
Deno.bench("Add 16x16 (F32)", { group: "16x16" }, () => {
  addMatrixFloat32({ shape: [16, 16], data: mat16AF32 }, {
    shape: [16, 16],
    data: mat16BF32,
  });
});
...
Deno.bench("Add 32x32 (F32)", { group: "32x32" }, () => {
  addMatrixFloat32({ shape: [32, 32], data: mat32AF32 }, {
    shape: [32, 32],
    data: mat32BF32,
  });
});
...
Deno.bench("Add 64x64 (F32)", { group: "64x64" }, () => {
  addMatrixFloat32({ shape: [64, 64], data: mat64AF32 }, {
    shape: [64, 64],
    data: mat64BF32,
  });
});
...
Deno.bench("Add 128x128 (F32)", { group: "128x128" }, () => {
  addMatrixFloat32({ shape: [128, 128], data: mat128AF32 }, {
    shape: [128, 128],
    data: mat128BF32,
  });
});
...
Deno.bench("Add 256x256 (F32)", { group: "256x256" }, () => {
  addMatrixFloat32({ shape: [256, 256], data: mat256AF32 }, {
    shape: [256, 256],
    data: mat256BF32,
  });
});
...
Deno.bench("Add 1x1 (I32)", { group: "1x1" }, () => {
  addMatrixInt32({ shape: [1, 1], data: mat1AI32 }, {
    shape: [1, 1],
    data: mat1BI32,
  });
});
...
Deno.bench("Add 2x2 (I32)", { group: "2x2" }, () => {
  addMatrixInt32({ shape: [2, 2], data: mat2AI32 }, {
    shape: [2, 2],
    data: mat2BI32,
  });
});
...
Deno.bench("Add 4x4 (I32)", { group: "4x4" }, () => {
  addMatrixInt32({ shape: [4, 4], data: mat4AI32 }, {
    shape: [4, 4],
    data: mat4BI32,
  });
});
...
Deno.bench("Add 8x8 (I32)", { group: "8x8" }, () => {
  addMatrixInt32({ shape: [8, 8], data: mat8AI32 }, {
    shape: [8, 8],
    data: mat8BI32,
  });
});
...
Deno.bench("Add 16x16 (I32)", { group: "16x16" }, () => {
  addMatrixInt32({ shape: [16, 16], data: mat16AI32 }, {
    shape: [16, 16],
    data: mat16BI32,
  });
});
...
Deno.bench("Add 32x32 (I32)", { group: "32x32" }, () => {
  addMatrixInt32({ shape: [32, 32], data: mat32AI32 }, {
    shape: [32, 32],
    data: mat32BI32,
  });
});
...
Deno.bench("Add 64x64 (I32)", { group: "64x64" }, () => {
  addMatrixInt32({ shape: [64, 64], data: mat64AI32 }, {
    shape: [64, 64],
    data: mat64BI32,
  });
});
...
Deno.bench("Add 128x128 (I32)", { group: "128x128" }, () => {
  addMatrixInt32({ shape: [128, 128], data: mat128AI32 }, {
    shape: [128, 128],
    data: mat128BI32,
  });
});
...
Deno.bench("Add 256x256 (I32)", { group: "256x256" }, () => {
  addMatrixInt32({ shape: [256, 256], data: mat256AI32 }, {
    shape: [256, 256],
    data: mat256BI32,
  });
});
...
Deno.bench("Add 1x1 (F64 flat)", { group: "1x1" }, () => {
  addMatrixFloat64Flat({ shape: [1, 1], data: mat1AF64 }, {
    shape: [1, 1],
    data: mat1BF64,
  });
});
...
Deno.bench("Add 2x2 (F64 flat)", { group: "2x2" }, () => {
  addMatrixFloat64Flat({ shape: [2, 2], data: mat2AF64 }, {
    shape: [2, 2],
    data: mat2BF64,
  });
});
...
Deno.bench("Add 4x4 (F64 flat)", { group: "4x4" }, () => {
  addMatrixFloat64Flat({ shape: [4, 4], data: mat4AF64 }, {
    shape: [4, 4],
    data: mat4BF64,
  });
});
...
Deno.bench("Add 8x8 (F64 flat)", { group: "8x8" }, () => {
  addMatrixFloat64Flat({ shape: [8, 8], data: mat8AF64 }, {
    shape: [8, 8],
    data: mat8BF64,
  });
});
...
Deno.bench("Add 16x16 (F64 flat)", { group: "16x16" }, () => {
  addMatrixFloat64Flat({ shape: [16, 16], data: mat16AF64 }, {
    shape: [16, 16],
    data: mat16BF64,
  });
});
...
Deno.bench("Add 32x32 (F64 flat)", { group: "32x32" }, () => {
  addMatrixFloat64Flat({ shape: [32, 32], data: mat32AF64 }, {
    shape: [32, 32],
    data: mat32BF64,
  });
});
...
Deno.bench("Add 64x64 (F64 flat)", { group: "64x64" }, () => {
  addMatrixFloat64Flat({ shape: [64, 64], data: mat64AF64 }, {
    shape: [64, 64],
    data: mat64BF64,
  });
});
...
Deno.bench("Add 128x128 (F64 flat)", { group: "128x128" }, () => {
  addMatrixFloat64Flat({ shape: [128, 128], data: mat128AF64 }, {
    shape: [128, 128],
    data: mat128BF64,
  });
});
...
Deno.bench("Add 256x256 (F64 flat)", { group: "256x256" }, () => {
  addMatrixFloat64Flat({ shape: [256, 256], data: mat256AF64 }, {
    shape: [256, 256],
    data: mat256BF64,
  });
});
...
Deno.bench("Add 1x1 (F32 flat)", { group: "1x1" }, () => {
  addMatrixFloat32Flat({ shape: [1, 1], data: mat1AF32 }, {
    shape: [1, 1],
    data: mat1BF32,
  });
});
...
Deno.bench("Add 2x2 (F32 flat)", { group: "2x2" }, () => {
  addMatrixFloat32Flat({ shape: [2, 2], data: mat2AF32 }, {
    shape: [2, 2],
    data: mat2BF32,
  });
});
...
Deno.bench("Add 4x4 (F32 flat)", { group: "4x4" }, () => {
  addMatrixFloat32Flat({ shape: [4, 4], data: mat4AF32 }, {
    shape: [4, 4],
    data: mat4BF32,
  });
});
...
Deno.bench("Add 8x8 (F32 flat)", { group: "8x8" }, () => {
  addMatrixFloat32Flat({ shape: [8, 8], data: mat8AF32 }, {
    shape: [8, 8],
    data: mat8BF32,
  });
});
...
Deno.bench("Add 16x16 (F32 flat)", { group: "16x16" }, () => {
  addMatrixFloat32Flat({ shape: [16, 16], data: mat16AF32 }, {
    shape: [16, 16],
    data: mat16BF32,
  });
});
...
Deno.bench("Add 32x32 (F32 flat)", { group: "32x32" }, () => {
  addMatrixFloat32Flat({ shape: [32, 32], data: mat32AF32 }, {
    shape: [32, 32],
    data: mat32BF32,
  });
});
...
Deno.bench("Add 64x64 (F32 flat)", { group: "64x64" }, () => {
  addMatrixFloat32Flat({ shape: [64, 64], data: mat64AF32 }, {
    shape: [64, 64],
    data: mat64BF32,
  });
});
...
Deno.bench("Add 128x128 (F32 flat)", { group: "128x128" }, () => {
  addMatrixFloat32Flat({ shape: [128, 128], data: mat128AF32 }, {
    shape: [128, 128],
    data: mat128BF32,
  });
});
...
Deno.bench("Add 256x256 (F32 flat)", { group: "256x256" }, () => {
  addMatrixFloat32Flat({ shape: [256, 256], data: mat256AF32 }, {
    shape: [256, 256],
    data: mat256BF32,
  });
});
...
Deno.bench("Add 1x1 (I32 flat)", { group: "1x1" }, () => {
  addMatrixInt32Flat({ shape: [1, 1], data: mat1AI32 }, {
    shape: [1, 1],
    data: mat1BI32,
  });
});
...
Deno.bench("Add 2x2 (I32 flat)", { group: "2x2" }, () => {
  addMatrixInt32Flat({ shape: [2, 2], data: mat2AI32 }, {
    shape: [2, 2],
    data: mat2BI32,
  });
});
...
Deno.bench("Add 4x4 (I32 flat)", { group: "4x4" }, () => {
  addMatrixInt32Flat({ shape: [4, 4], data: mat4AI32 }, {
    shape: [4, 4],
    data: mat4BI32,
  });
});
...
Deno.bench("Add 8x8 (I32 flat)", { group: "8x8" }, () => {
  addMatrixInt32Flat({ shape: [8, 8], data: mat8AI32 }, {
    shape: [8, 8],
    data: mat8BI32,
  });
});
...
Deno.bench("Add 16x16 (I32 flat)", { group: "16x16" }, () => {
  addMatrixInt32Flat({ shape: [16, 16], data: mat16AI32 }, {
    shape: [16, 16],
    data: mat16BI32,
  });
});
...
Deno.bench("Add 32x32 (I32 flat)", { group: "32x32" }, () => {
  addMatrixInt32Flat({ shape: [32, 32], data: mat32AI32 }, {
    shape: [32, 32],
    data: mat32BI32,
  });
});
...
Deno.bench("Add 64x64 (I32 flat)", { group: "64x64" }, () => {
  addMatrixInt32Flat({ shape: [64, 64], data: mat64AI32 }, {
    shape: [64, 64],
    data: mat64BI32,
  });
});
...
Deno.bench("Add 128x128 (I32 flat)", { group: "128x128" }, () => {
  addMatrixInt32Flat({ shape: [128, 128], data: mat128AI32 }, {
    shape: [128, 128],
    data: mat128BI32,
  });
});
...
Deno.bench("Add 256x256 (I32 flat)", { group: "256x256" }, () => {
  addMatrixInt32Flat({ shape: [256, 256], data: mat256AI32 }, {
    shape: [256, 256],
    data: mat256BI32,
  });
});
...
Deno.bench("Add 1x1 (WASM F64)", { group: "1x1" }, () => {
  addMatrixWasmF64({ shape: [1, 1], data: mat1AF64 }, {
    shape: [1, 1],
    data: mat1BF64,
  });
});
...
Deno.bench("Add 2x2 (WASM F64)", { group: "2x2" }, () => {
  addMatrixWasmF64({ shape: [2, 2], data: mat2AF64 }, {
    shape: [2, 2],
    data: mat2BF64,
  });
});
...
Deno.bench("Add 4x4 (WASM F64)", { group: "4x4" }, () => {
  addMatrixWasmF64({ shape: [4, 4], data: mat4AF64 }, {
    shape: [4, 4],
    data: mat4BF64,
  });
});
...
Deno.bench("Add 8x8 (WASM F64)", { group: "8x8" }, () => {
  addMatrixWasmF64({ shape: [8, 8], data: mat8AF64 }, {
    shape: [8, 8],
    data: mat8AF64,
  });
});
...
Deno.bench("Add 16x16 (WASM F64)", { group: "16x16" }, () => {
  addMatrixWasmF64({ shape: [16, 16], data: mat16AF64 }, {
    shape: [16, 16],
    data: mat16BF64,
  });
});
...
Deno.bench("Add 32x32 (WASM F64)", { group: "32x32" }, () => {
  addMatrixWasmF64({ shape: [32, 32], data: mat32AF64 }, {
    shape: [32, 32],
    data: mat32BF64,
  });
});
...
Deno.bench("Add 64x64 (WASM F64)", { group: "64x64" }, () => {
  addMatrixWasmF64({ shape: [64, 64], data: mat64AF64 }, {
    shape: [64, 64],
    data: mat64BF64,
  });
});
...
Deno.bench("Add 128x128 (WASM F64)", { group: "128x128" }, () => {
  addMatrixWasmF64({ shape: [128, 128], data: mat128AF64 }, {
    shape: [128, 128],
    data: mat128BF64,
  });
});
...
Deno.bench("Add 256x256 (WASM F64)", { group: "256x256" }, () => {
  addMatrixWasmF64({ shape: [256, 256], data: mat256AF64 }, {
    shape: [256, 256],
    data: mat256BF64,
  });
});
...
Deno.bench("Add 1x1 (WASM SIMD F64)", { group: "1x1" }, () => {
  addMatrixWasmSimdF64({ shape: [1, 1], data: mat1AF64 }, {
    shape: [1, 1],
    data: mat1BF64,
  });
});
...
Deno.bench("Add 2x2 (WASM SIMD F64)", { group: "2x2" }, () => {
  addMatrixWasmSimdF64({ shape: [2, 2], data: mat2AF64 }, {
    shape: [2, 2],
    data: mat2BF64,
  });
});
...
Deno.bench("Add 4x4 (WASM SIMD F64)", { group: "4x4" }, () => {
  addMatrixWasmSimdF64({ shape: [4, 4], data: mat4AF64 }, {
    shape: [4, 4],
    data: mat4BF64,
  });
});
...
Deno.bench("Add 8x8 (WASM SIMD F64)", { group: "8x8" }, () => {
  addMatrixWasmSimdF64({ shape: [8, 8], data: mat8AF64 }, {
    shape: [8, 8],
    data: mat8AF64,
  });
});
...
Deno.bench("Add 16x16 (WASM SIMD F64)", { group: "16x16" }, () => {
  addMatrixWasmSimdF64({ shape: [16, 16], data: mat16AF64 }, {
    shape: [16, 16],
    data: mat16BF64,
  });
});
...
Deno.bench("Add 32x32 (WASM SIMD F64)", { group: "32x32" }, () => {
  addMatrixWasmSimdF64({ shape: [32, 32], data: mat32AF64 }, {
    shape: [32, 32],
    data: mat32BF64,
  });
});
...
Deno.bench("Add 64x64 (WASM SIMD F64)", { group: "64x64" }, () => {
  addMatrixWasmSimdF64({ shape: [64, 64], data: mat64AF64 }, {
    shape: [64, 64],
    data: mat64BF64,
  });
});
...
Deno.bench("Add 128x128 (WASM SIMD F64)", { group: "128x128" }, () => {
  addMatrixWasmSimdF64({ shape: [128, 128], data: mat128AF64 }, {
    shape: [128, 128],
    data: mat128BF64,
  });
});
...
Deno.bench("Add 256x256 (WASM SIMD F64)", { group: "256x256" }, () => {
  addMatrixWasmSimdF64({ shape: [256, 256], data: mat256AF64 }, {
    shape: [256, 256],
    data: mat256BF64,
  });
});
...
Deno.bench("Add 1x1 (WASM SIMD F32)", { group: "1x1" }, () => {
  addMatrixWasmSimdF32({ shape: [1, 1], data: mat1AF32 }, {
    shape: [1, 1],
    data: mat1BF32,
  });
});
...
Deno.bench("Add 2x2 (WASM SIMD F32)", { group: "2x2" }, () => {
  addMatrixWasmSimdF32({ shape: [2, 2], data: mat2AF32 }, {
    shape: [2, 2],
    data: mat2BF32,
  });
});
...
Deno.bench("Add 4x4 (WASM SIMD F32)", { group: "4x4" }, () => {
  addMatrixWasmSimdF32({ shape: [4, 4], data: mat4AF32 }, {
    shape: [4, 4],
    data: mat4BF32,
  });
});
...
Deno.bench("Add 8x8 (WASM SIMD F32)", { group: "8x8" }, () => {
  addMatrixWasmSimdF32({ shape: [8, 8], data: mat8AF32 }, {
    shape: [8, 8],
    data: mat8AF32,
  });
});
...
Deno.bench("Add 16x16 (WASM SIMD F32)", { group: "16x16" }, () => {
  addMatrixWasmSimdF32({ shape: [16, 16], data: mat16AF32 }, {
    shape: [16, 16],
    data: mat16BF32,
  });
});
...
Deno.bench("Add 32x32 (WASM SIMD F32)", { group: "32x32" }, () => {
  addMatrixWasmSimdF32({ shape: [32, 32], data: mat32AF32 }, {
    shape: [32, 32],
    data: mat32BF32,
  });
});
...
Deno.bench("Add 64x64 (WASM SIMD F32)", { group: "64x64" }, () => {
  addMatrixWasmSimdF32({ shape: [64, 64], data: mat64AF32 }, {
    shape: [64, 64],
    data: mat64BF32,
  });
});
...
Deno.bench("Add 128x128 (WASM SIMD F32)", { group: "128x128" }, () => {
  addMatrixWasmSimdF32({ shape: [128, 128], data: mat128AF32 }, {
    shape: [128, 128],
    data: mat128BF32,
  });
});
...
Deno.bench("Add 256x256 (WASM SIMD F32)", { group: "256x256" }, () => {
  addMatrixWasmSimdF32({ shape: [256, 256], data: mat256AF32 }, {
    shape: [256, 256],
    data: mat256BF32,
  });
});
...
Deno.bench("Add 1x1 (WASM SIMD I32)", { group: "1x1", baseline: true }, () => {
  addMatrixWasmSimdI32({ shape: [1, 1], data: mat1AI32 }, {
    shape: [1, 1],
    data: mat1BI32,
  });
});
...
Deno.bench("Add 2x2 (WASM SIMD I32)", { group: "2x2", baseline: true }, () => {
  addMatrixWasmSimdI32({ shape: [2, 2], data: mat2AI32 }, {
    shape: [2, 2],
    data: mat2BI32,
  });
});
...
Deno.bench("Add 4x4 (WASM SIMD I32)", { group: "4x4", baseline: true }, () => {
  addMatrixWasmSimdI32({ shape: [4, 4], data: mat4AI32 }, {
    shape: [4, 4],
    data: mat4BI32,
  });
});
...
Deno.bench("Add 8x8 (WASM SIMD I32)", { group: "8x8", baseline: true }, () => {
  addMatrixWasmSimdI32({ shape: [8, 8], data: mat8AI32 }, {
    shape: [8, 8],
    data: mat8AI32,
  });
});
...
Deno.bench(
  "Add 16x16 (WASM SIMD I32)",
  { group: "16x16", baseline: true },
  () => {
    addMatrixWasmSimdI32({ shape: [16, 16], data: mat16AI32 }, {
      shape: [16, 16],
      data: mat16BI32,
    });
  },
...
Deno.bench(
  "Add 32x32 (WASM SIMD I32)",
  { group: "32x32", baseline: true },
  () => {
    addMatrixWasmSimdI32({ shape: [32, 32], data: mat32AI32 }, {
      shape: [32, 32],
      data: mat32BI32,
    });
  },
...
Deno.bench(
  "Add 64x64 (WASM SIMD I32)",
  { group: "64x64", baseline: true },
  () => {
    addMatrixWasmSimdI32({ shape: [64, 64], data: mat64AI32 }, {
      shape: [64, 64],
      data: mat64BI32,
    });
  },
...
Deno.bench(
  "Add 128x128 (WASM SIMD I32)",
  { group: "128x128", baseline: true },
  () => {
    addMatrixWasmSimdI32({ shape: [128, 128], data: mat128AI32 }, {
      shape: [128, 128],
      data: mat128BI32,
    });
  },
...
Deno.bench(
  "Add 256x256 (WASM SIMD I32)",
  { group: "256x256", baseline: true },
  () => {
    addMatrixWasmSimdI32({ shape: [256, 256], data: mat256AI32 }, {
      shape: [256, 256],
      data: mat256BI32,
    });
  },
